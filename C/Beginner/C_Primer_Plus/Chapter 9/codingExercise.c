...
double power(double n, int index)
{
    ...
    //conver negative index ==> positive
    if (index < 0)
    {
		n = 1.0 / n;	//reciprocal
		index *= -1;
...
//exercise 9 
//using recursion and division
//to make function more effcient
double betterPower(double base, int index)
{
	if (index < 0)
	{
		base = 1.0 / base;
